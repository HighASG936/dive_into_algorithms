...
if __name__ == "__main__":
    ...
    for n in range(0, len(itinerary)*1000):
    ...
    display_results(cities, itinerary_ps, N, 'Tuned Simulated Annealing', 'figure5')
    ...
    itinerary_ps = itinerary.copy()
    for n in range(0, len(itinerary)*1000):
        itinerary_ps = perturb_sa3(cities, itinerary_ps, time, maxitin)
    display_results(cities, itinerary_ps, N, 'Simulated Annealing allowing reset', 'figure6')  
